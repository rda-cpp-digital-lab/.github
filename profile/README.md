...
NICS Crop Physiology Lab GitHub Organization입니다.

이 Organization은 연구 코드 관리, 협업, 재현 가능한 연구 환경 구축을 목적으로 운영됩니다.
...
다음 파일은 반드시 `.gitignore`에 포함해야 합니다.
